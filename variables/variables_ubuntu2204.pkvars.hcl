...
iso_url="https://releases.ubuntu.com/22.04/ubuntu-22.04.02-live-server-amd64.iso"
output_directory="output-ubuntu2204"
output_vagrant="./vbox/packer-ubuntu2204-g2.box"
provision_script_options="-u false -p false -w false -h true -z true"
ssh_password="password"
ssh_username="ubuntu"
switch_name="Ethernet_Team"
